						...
						<tr>				
							...
							<td>
								<?php if ($key->status!='Selesai') { ?>
									<a href="<?php echo base_url() ?>Transaksi/editTransaksi/<?php echo $key->id_transaksi ?>/<?php echo $key->id_driver ?>" class="btn btn-primary">Selesai</a>
									<?php if ($key->id_driver!=NULL) {?>
									<a href="<?php echo base_url() ?>Transaksi/keUbahDriverTransaksi/<?php echo $key->id_transaksi?>" class="btn btn-success">Ubah Driver</a>
									<?php } else { ?>
										<a href="<?php echo base_url() ?>Transaksi/keAddDriverTransaksi/<?php echo $key->id_transaksi ?>" class="btn btn-warning">Pilih Driver</a>
									<?php } ?>
								<?php } ?>
								<a href="<?php echo base_url() ?>Transaksi/deleteTransaksi/<?php echo $key->id_transaksi ?>" class="btn btn-danger">Hapus</a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
