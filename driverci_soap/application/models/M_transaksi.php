...
class M_transaksi extends CI_Model {
	...
	public function getTarif($waktu)
	{
		$tarifHarga = $this->db->query("SELECT harga FROM harga where id_harga = '".$waktu."'");
		return $tarifHarga->result_array();
	}

	public function getPaket()
	{
		$tarifHarga = $this->db->query("SELECT * FROM harga");
		return $tarifHarga->result_array();
	}
}