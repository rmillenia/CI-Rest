...
<!--===============================================================================================-->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/assets/css/select2.min.css">
<!--===============================================================================================-->
    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-pic js-tilt" data-tilt>
          <img src="<?php echo base_url();?>foto/driver.png" alt="IMG">
        </div>
        ...
        <div class="alert alert-warning alert-dismissable">
          ...
          <div class="wrap-input100">
            <input class="input100" type="date" name="ttl" placeholder="Date of Birth">
            <span class="focus-input100"></span>
            <span class="symbol-input100">
          ...
          <div class="text-center">
            <a class="txt2" href="<?php echo site_url()?>Home/kelogin">
